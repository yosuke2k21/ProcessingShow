...
///////////  2620150583 2年3組23番 鈴木洋祐  ////////////
  ...
  void setup(){
    ...
    img1 = loadImage("monitor_picture.png");
    img2 = loadImage("effect_picture.png");
    ...
    player1[0] = mini.loadFile("1-01 Trap Queen.mp3");
    player1[1] = mini.loadFile("05 Sow (Original Mix).mp3");
    player2[0] = mini.loadFile("1-03 679 (feat. Monty).mp3");
    player2[1] = mini.loadFile("09 Jukebox Joints (feat. Joe Fox & Kanye West).mp3");
  }
